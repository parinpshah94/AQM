...
#Divide into test and train + fit a regression
...
#Predict medv values for the test dataset
...
#Predictions made by the neural network are (in general) more concetrated around the line
